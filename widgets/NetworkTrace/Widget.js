...
define([
  ...
  return declare([BaseWidget], {
    ...
    _addInputLocation: function (graphic, type) {
      ...
      domAttr.set(this.inputLocTab, "aria-label", this.nls.lblInputLocTab + " (" + this._flagCount + ")");
    ...
    _removeSelectedLocation: function (evt) {
      ...
      domAttr.set(this.lblInputLoc, "innerHTML",
        this.nls.lblInputLocTab + " (" + this._flagCount + ")");
    ...
    _addBarrierLocation: function (graphic, type) {
      ...
      domAttr.set(this.barrierCountLabel, "innerHTML", this.nls.lblBlockLocTab +
        " (" + this._barrierCount + ")");
      domAttr.set(this.barrierLocTab, "aria-label", this.nls.lblBlockLocTab +
        " (" + this._barrierCount + ")");
    ...
    _onBlockCloseDivClicked: function (evt) {
      ...
      domAttr.set(this.lblBlockLoc, "innerHTML",
        this.nls.lblBlockLocTab + " (" + this._barrierCount + ")");
    ...
    _addSkipLocation: function (type, skippedFeatureUniqueId) {
      ...
      domAttr.set(this.skipLocationCountLabel, "innerHTML", this.nls.lblSkipLocTab +
        " (" + this._skipLocationCount + ")");
      domAttr.set(this.skipLocationTab, "aria-label", this.nls.lblSkipLocTab +
        " (" + this._skipLocationCount + ")");
      ...
      skipLocationCloseDiv = domConstruct.create("div", {
        ...
        "aria-label": this.nls.closeButtonLabel + "  " + this.nls.lblSkipLocation + this._inputSkip,
        "tabindex": "2",
        "role": "button"
      }, skipLocationDiv);
    ...
    _addSkipAllLocationButton: function (resultContainer) {
      ...
      var skipAllButton = domConstruct.create("div", {
        ...
        "aria-label": this.nls.skipAllLocationButtonLabel,
        "role": "button",
        "tabindex": "0",
