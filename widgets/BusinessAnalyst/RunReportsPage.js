...
function (array, declare, domClass, domConstruct, domStyle, query, when, _TemplatedMixin, _WidgetBase, _WidgetsInTemplateMixin, webMercatorUtils, SelectableTree, ReportPlayerGEUtil, ReportPlayer, PlayerResizeModes, PlayerThemes, DataProviderGE, PlayerCommands,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WizardPage, _WidgetsInTemplateMixin], {
    ...
    runInfographic: function () {
      ...
      this.reportPlayer = new ReportPlayer({
        ...
        config: {
          esriDijitCssUrl: "https://js.arcgis.com/3.33/dijit/themes/claro/claro.css",
          esriCssUrl: "https://js.arcgis.com/3.33/esri/css/esri.css",
          playerSourceRootUrl: "https://js.arcgis.com/3.33/"
        },
        onClose: function () {
