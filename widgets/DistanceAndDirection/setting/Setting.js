    ...
    return dojoDeclare([jimuBaseWidgetSetting, dijitWidgetsInTemplateMixin], {
      ...
      postCreate: function () {
        ...
        if (window.isRTL && kernel.locale === "ar") {
          domStyle.set(this.helpLineBtn, "transform", "rotateY(180deg)");
          domStyle.set(this.helpPolygonBtn, "transform", "rotateY(180deg");
        } else {
          domStyle.set(this.helpLineBtn, "transform", "");
          domStyle.set(this.helpPolygonBtn, "transform", "");
        }
