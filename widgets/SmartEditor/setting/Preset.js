...
define(
  ...
  function (
    ...
    return declare([BaseWidgetSetting, Evented, _TemplatedMixin], {
      ...
      _isSelectPresetValueButtonClicked: false,
      _isFirstTime: true,
      ...
      postCreate: function () {
        ...
        this._isSelectPresetValueButtonClicked = false;
      ...
      _createValueDijit: function (fieldType, presetValue, resetLayersFieldTable) {
        ...
        if (node) {
          ...
          this.own(on(this.presetValueDijitNode, 'change', lang.hitch(this, function (value) {
            if (!this._checkIfDomainFieldSelected() && fieldType !== "esriFieldTypeDate" &&
            !this._isSelectPresetValueButtonClicked && !this._isFirstTime) {
              this.chooseFromLayerInfo = null;
            } else {
              this._isSelectPresetValueButtonClicked = false;
            }
      ...
      */
      ...
      _onSelectPresetValueButtonClick: function () {
        this._isSelectPresetValueButtonClicked = true;
        ...
        if (isDomainFieldSelected) {
          ...
          on(this.ChooseFromLayerObj, "updatePresetValue", lang.hitch(this, function (chooseFromLayerInfo) {
            ...
            this.presetValueDijitNode.set("value", chooseFromLayerInfo.selectedValue);
          }));
