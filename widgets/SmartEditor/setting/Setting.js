      ...
      **/
      ...
      getConfig: function () {
        ...
        if (this.customSettingsRadioBtn.checked) {
          ...
          if (!fieldInfoStatus.isValidFields) {
            var layerInstance;
       ...
       */
      _initAttributeActionsTable: function (tableContainerNode, isPreset) {
