        ...
        return declare([BaseWidgetSetting, Evented, _WidgetsInTemplateMixin], {
            ...
            */
                ...
                if (this.fixedRadioButton.checked) {
                    ...
                    if (this.selectValueRadioButton.checked) {
                        ...
                        if (relativeDatesData.chooseFromLayerInfo && relativeDatesData.chooseFromLayerInfo.selectedValue) {
                            relativeDatesData.dateTime = this._convertToEpoch(new Date(relativeDatesData.chooseFromLayerInfo.selectedValue));
                        }
                    }
                } else if (this.currentRadioButton.checked) {
            ...
            _addLayerSelectors: function () {
                ...
                if (this.relativeDates.chooseFromLayerInfo && this.relativeDates.chooseFromLayerInfo.layerId && this._isFirsTime) {
            ...
            */
            _addLayerFieldsOptions: function () {
                ...
                if (this.relativeDates.chooseFromLayerInfo && this.relativeDates.chooseFromLayerInfo.field && this._isFirsTime) {
            ...
            _createValueProvider: function () {
                ...
                if (this.valueProvider) {
                    ...
                    if (this.relativeDates.chooseFromLayerInfo && this.relativeDates.chooseFromLayerInfo.selectedValue && this._isFirsTime) {
                        this.valueProvider.checkedNameDiv.innerHTML = this.relativeDates.chooseFromLayerInfo.selectedValue;
