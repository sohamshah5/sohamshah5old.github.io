    ...
    mo.getCoordinatesData = function (geometry, geometryService) {
      ...
      mo.getProjectedGeometry(
        ...
        lang.hitch(this, function (latLongCoordinates) {
          ...
          this._getMGRSCoordinatesData(def, coordinatesInfo, geometryService);
        }));
      return def.promise;
    };


    mo._getMGRSCoordinatesData = function (def, coordinatesInfo, geometryService) {
      //Create params required by geometry service
      var params = {
        conversionMode : 'mgrsDefault',
        numOfDigits : 5,
        sr: 4326,
        coordinates: [
          [coordinatesInfo.LatLong.x, coordinatesInfo.LatLong.y]
        ],
        conversionType: "MGRS",
        numOfDigits: 5,
        rounding: true,
      ...
      geometryService.toGeoCoordinateString(params).then(function (MGRSCoordsData) {
        //Store the MGRS values in coordinates info object
        coordinatesInfo.MGRS = {
          "MGRS": MGRSCoordsData[0]
        };
