    ...
    **/
    _createPanels: function () {
      ...
      if (this.config.enableDirection) {
        ...
        domAttr.set(this._featureInfoPanel.domNode, "aria-label", this.nls.informationContentLabel);
    ...
    **/
    _onFeatureCountComplete: function () {
      ...
      if (this._isNoFeature) {
        ...
        noFeatureDiv = domConstruct.create("div", {
    ...
    _setItemCount: function (templateDiv, value, isFeatureCount) {
      ...
      if (divFeatureCount) {
        ...
        if (isFeatureCount) {
          ...
          if (templateDiv) {
            domAttr.set(templateDiv, "title",
              domAttr.get(templateDiv, "title") + " " + formattedValue);
          }
        }
      }
    },
